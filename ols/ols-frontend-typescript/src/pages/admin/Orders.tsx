  ...
  return (
    <div className="container mt-4">
      ...
      <div className="row">
        {orderData.length > 0 ? (
          orderData.map((order) => {
            const bgColor = order.orderStatus === "PAID" ? "success" : "danger";
              ...
              <div className="col-md-4 mb-4" key={order.orderId}>
                <div className="card shadow-lg border-0">
                  <div className="card-body text-center">
                    ...
                    <p className={`card-text text-white bg-${bgColor}`}>
                      <strong>Order Status:</strong> {order.orderStatus}
                    </p>
                    <p className="card-text">
                      <strong>Order Total Amount:</strong> ₹{order.orderTotalAmount}
                    </p>
                    <p className="card-text">
                    ...
                    <p className="card-text">
                      <strong>User Email:</strong> {order.user.userEmail}
                    </p>
                  </div>
                </div>
              </div>
